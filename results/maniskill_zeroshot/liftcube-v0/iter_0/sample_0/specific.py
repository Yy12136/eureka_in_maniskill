...
def compute_dense_reward(self, action) -> float:
    ...
    weight_reach = 0.0500    # Weight for reaching the cube
    weight_grasp = 0.4750    # Weight for successfully grasping the cube
    weight_lift = 0.4750    # Weight for lifting the cube to the desired height
