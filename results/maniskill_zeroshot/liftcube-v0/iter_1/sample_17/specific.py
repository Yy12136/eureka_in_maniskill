...
def compute_dense_reward(self, action) -> float:
    ...
    weight_grasp = 0.3    # Primary weight for grasping the cube
    weight_lift = 0.5     # Primary weight for lifting the cube
    weight_reach = 0.2    # Secondary weight for reaching the cube
    ...
    max_distance = 0.5  # Maximum distance for normalization
    reward_reach = 1.0 - min(distance / max_distance, 1.0)  # Inverse scaling
