...
def compute_dense_reward(self, action) -> float:
    ...
    weight_reach = 0.8000    # Weight for reaching the cube
    weight_grasp = 0.1000    # Weight for successfully grasping the cube
    weight_lift = 0.1000    # Weight for lifting the cube to the desired height
    weight_reach = 0.8000    # Note: weight_reach + weight_grasp + weight_lift = 1.0
    ...
    reward_reach = 1.0 - np.tanh(10.0 * dist_to_cube)
