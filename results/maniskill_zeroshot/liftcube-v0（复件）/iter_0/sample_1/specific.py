...
def compute_dense_reward(self, action) -> float:
    ...
    weight_grasp = 0.1500    # Primary weight for grasping the cube
    weight_lift = 0.8000    # Primary weight for lifting the cube
    weight_smooth = 0.0500    # Secondary weight for smooth motion
