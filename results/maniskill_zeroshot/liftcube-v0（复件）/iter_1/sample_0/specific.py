...
def compute_dense_reward(self, action) -> float:
    ...
    weight_grasp = 0.4657    # Primary weight for grasping the cube
    weight_lift = 0.4843    # Primary weight for lifting the cube
    weight_reach = 0.0500    # Secondary weight for reaching the cube
