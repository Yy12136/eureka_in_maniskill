...
def compute_dense_reward(self, action) -> float:
    ...
    weight_distance_to_cube = 0.4  # Weight for minimizing distance to cube
    weight_distance_to_goal = 0.3  # Weight for minimizing distance to goal
    ...
    # 2. Distance to cube reward (negative distance to encourage minimizing it)
    distance_to_cube = np.linalg.norm(self.tcp.pose.p - self.obj.pose.p)
    reward_distance_to_cube = -distance_to_cube
    
    # 3. Distance to goal reward (negative distance to encourage minimizing it)
